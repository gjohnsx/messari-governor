...
export default function Footer() {
  return (
    <footer
      className="bg-white border-t border-gray-200 dark:border-gray-800 dark:bg-messari-600"
      ...
      <div className="px-6 pt-16 pb-8 mx-auto max-w-7xl sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <svg
              className="hidden mx-auto md:mx-0 dark:block"
              width="189"
              height="29"
              viewBox="0 0 189 29"
              fill="none"
            ...
            <p className="px-4 text-sm leading-6 text-center text-gray-500 dark:text-gray-400 md:px-0 md:text-left">
            ...
            <div className="flex justify-center space-x-6 md:justify-start">
              {navigation.social.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className="text-gray-500 dark:text-gray-400 dark:hover:text-gray-500 hover:text-gray-600"
                >
                ...
                <ul role="list" className="mt-6 space-y-4">
                  {navigation.data.map((item) => (
                    <li key={item.name}>
                      <a
                        href={item.href}
                        className="text-sm leading-6 text-gray-400 dark:text-gray-300 hover:text-gray-500 dark:hover:text-white"
                      >
                        {item.name}
                      </a>
                    </li>
        ...
        <div className="pt-8 mt-16 border-t border-white/10 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
          ...
          <form className="mt-6 sm:flex sm:max-w-md lg:mt-0">
            ...
            <input
              ...
              autoComplete="email"
              required
              className="w-full min-w-0 appearance-none rounded-md border-white/10 bg-gray-400/30 dark:bg-gray-400/10 px-[calc(theme(spacing.3)-1px)] py-[calc(theme(spacing[1.5])-1px)] text-base leading-7 text-gray-900 dark:text-white placeholder-gray-500 shadow-sm focus:border--500 focus:ring-messari-blue-light sm:w-56 sm:text-sm sm:leading-6"
                ...
                <li key={item.name} className="flex items-center space-x-1">
                  <a
                    ...
                    className={clsx(
                      ...
                      "text-sm leading-6 text-gray-400 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white"
                    )}
                  >
                    {item.name}
                  </a>
