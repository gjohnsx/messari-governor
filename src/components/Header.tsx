...
import messariLogo from '@/images/messari-logo.svg'
                    ...
                    <Link href="/governor" className="-m-1.5 p-1.5">
                      ...
                      <svg width="37" height="36" viewBox="0 0 37 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_652_19018)">
                          <path d="M0 0V36L9.27391 26.7825V9.21751L0 0Z" fill="white"/>
                          <path d="M18.2609 18.15L13.6246 13.542V36.0002L22.8971 26.7827V13.542L18.2609 18.15Z" fill="white"/>
                          <path d="M27.2478 9.21751V36L36.5217 26.7825V0L27.2478 9.21751Z" fill="white"/>
                        </g>
                        <defs>
